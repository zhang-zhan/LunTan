...
from downPagePinggu import *


class Down_Pinggu_Forum():
...
def scanItemUrl(url, initDeadline = 1438358400):
    print 'start。。。'

    #the root url
    turl = "http://bbs.echang.cn/"
    ...
    downlist = Down_Pinggu_Forum(turl, deadline)
...
def scanItemRun():
    #天涯的版块URL
    section = ['forum-30-1.html','forum-2-1.html']
