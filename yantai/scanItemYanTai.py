...
from downPageYanTai import *


class Down_YanTai_Forum():
...
def scanItemUrl(url, initDeadline = 1414640120):
    ...
    downlist = Down_YanTai_Forum(turl, deadline)
...
def scanItemRun():
    #天涯的版块URL
    section = ['forum-60-1.html','forum-111-1.html',"forum-83-1.html","forum-80-1.html"]
