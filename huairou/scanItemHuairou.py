...
from downPageHuairou import *


class Down_Huairou_Forum():
    ...
    def start_load(self, p_url, reList, first):
        ...
        next_page = next_page.split("http://www.hrlife.net/")[1]
        print next_page
...
def scanItemUrl(url, initDeadline = 1414640120):
    ...
    downlist = Down_Huairou_Forum(turl, deadline)
...
def scanItemRun():
    #天涯的版块URL
    section = ["forum-24-1.html",'forum-6-1.html',"forum-12-1.html","forum-448-1.html"]
