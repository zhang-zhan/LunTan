...
from downPageWeiFang import *


class Down_WeiFang_Forum():
...
def scanItemUrl(url, initDeadline = 1414640120):
    ...
    downlist = Down_WeiFang_Forum(turl, deadline)
...
def scanItemRun():
    #天涯的版块URL
    section = ['forum-130-1.html','forum-167-1.html',"forum-203-1.html"]
