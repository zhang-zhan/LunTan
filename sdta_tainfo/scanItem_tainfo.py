...
import time
import sys
import downPage_tainfo
import re
from bs4 import BeautifulSoup


class Down_sd_tainfo_Forum():
...
def scanItemUrl(url, initDeadline = 1414640120):
    ...
    downlist = Down_sd_tainfo_Forum(turl, deadline)
	...
	downPage_tainfo.down_page_run(myurl)
