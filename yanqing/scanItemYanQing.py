...
from downPageYanQing import *


class Down_Yanqing_Forum():
    ...
    def start_load(self, p_url, reList, first):
        ...
        mydic = soup.find("form",id="moderate").find_all("tbody",id=re.compile(r"normalthread_(\d+)"))
...
def scanItemUrl(url, initDeadline = 1414640120):
    ...
    downlist = Down_Yanqing_Forum(turl, deadline)
