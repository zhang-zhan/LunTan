...
from downPageRiZhao import *


class Down_RiZhao_Forum():
    ...
    def start_load(self, p_url, reList, first):
        ...
        try:
            ...
            next_page = next_page.split("http://bbs.rznews.cn/")[1]
        except:
            next_page = None
        print next_page
...
def scanItemUrl(url, initDeadline = 1414640120):
    ...
    downlist = Down_RiZhao_Forum(turl, deadline)
    ...
    for myurl in urlList2:
        myurl = myurl.split("http://bbs.rznews.cn/")[1]
        print 'L:%s' % myurl
...
def scanItemRun():
    #天涯的版块URL
    section = ["forum.php?mod=forumdisplay&fid=25",'forum.php?mod=forumdisplay&fid=34',"forum.php?mod=forumdisplay&fid=35","forum.php?mod=forumdisplay&fid=28","forum.php?mod=forumdisplay&fid=36"]
