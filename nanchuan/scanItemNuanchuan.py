...
from downPageNuanchuan import *


class Down_Nuanchuan_Forum():
...
def scanItemUrl(url, initDeadline = 1414640120):
    ...
    downlist = Down_Nuanchuan_Forum(turl, deadline)
...
def scanItemRun():
    #天涯的版块URL
    section = ['forum-343-1.html','forum-1000-1.html',"forum-1523-1.html","forum-1539-1.html"]
